                ...
                [
                    ...
                    dbc.Row(
                        [
                            ...
                            html.P("Country dropdown: Select one or more countries from the chosen continent to review their statistics"),
                            ...
                            html.P("Continent KPIs: Prints te average GDP, Population and Life Expectancy for the selected continent"),
                        ]
                    ),
                ]
            )
